...
adicional en FAD. La conclusión es que la IA \textit{sí} aporta valor a este problema,
pero la IA que gana es la parsimoniosa y bien validada, no la de mayor capacidad.

Este resultado no es una limitación del trabajo sino un hallazgo validado: documenta,
con un protocolo reproducible y libre de fuga, qué familia de modelos conviene a este
dominio y por qué. La evaluación por separado de ambas tablas reveló además que el
modelo idóneo depende del régimen de datos —parsimonia y árboles en FAD, árboles sobre
deltas en las series cortas de DFF, donde los modelos de mayor capacidad se vuelven
numéricamente inviables—, lo que justifica no asumir un único modelo universal. El
sistema entrega pronósticos con intervalos de predicción al 95\,\% cuya cobertura
empírica se verifica, y un marco reproducible de comparación que se extenderá, como
trabajo futuro, a las categorías basadas en empleo, al entrenamiento global del panel
(que rescata a los modelos profundos) y al tratamiento de los cambios de régimen
