...
profundas—, complementado con redes profundas entrenadas de forma \textbf{global} sobre el
panel completo. El sistema se entrena exclusivamente sobre las observaciones con fecha
...
(muestreo TPE multivariante, semilla fija) bajo un protocolo \textit{anidado y libre de
...
\textit{distribución predictiva completa}, medida con el CRPS \cita{21} sobre los
...
MASE $=0.121$ y BiTCN sobre diferencia $0.124$ (Tabla~\ref{tab:global_deep})—, ya mejor
que CatBoost y SARIMA. Dos refinamientos adicionales cierran la brecha con los
...
conocido sino BiTCN; la Figura~\ref{fig:forecast} muestra sus pronósticos frente a las fechas
reales. \textit{Confirmación multi-semilla:} para caracterizar la estabilidad,
...
profundo: en DFF el MASE varía apenas $\pm0.0006$ entre semillas, mientras que en FAD
—donde interviene la búsqueda de hiperparámetros— la variación sube a $\pm0.011$, reflejo
...
proviene de la capacidad del modelo sino de cómo se entrena} —global, sobre incrementos, con
escalado por serie y regularización ajustada—; sin esos ingredientes las mismas redes caen
por debajo del naïve, y modelos de gran nombre como DeepAR fallan. La respuesta a
