...
lleva a \textbf{AutoBiTCN a MASE $=0.114$ y AutoTiDE a $0.115$}, a la altura de ETS y Theta
...
global supera por sí solo a todos los estadísticos y árboles —MASE $=0.090$ frente a
$0.116$ de CatBoost y ETS, $\sim$23\,\% mejor— (SARIMA no es referencia válida en DFF: es
...
ambos resultados se reentrenaron con \textbf{ocho semillas independientes}, variando tanto
...
muy por debajo del mejor parsimonioso ($0.116$). En FAD el resultado es un \textbf{empate
estadístico}: AutoBiTCN promedia $0.114$ con desviación $0.008$ —intervalo
$[0.108,\,0.121]$—, un rango que contiene el listón parsimonioso ($0.117$); ni el modelo
...
mejor modelo profundo ($0.114$), pero sin descender hacia el oráculo de selección perfecta
...
AutoBiTCN & + optimización (Optuna) & \textbf{0.114} \\ \hline
...
de datos. La validación con ocho semillas cuantifica esta estabilidad para el ganador
...
DFF —$\sim$23\,\% por debajo del mejor parsimonioso (CatBoost/ETS $0.116$)— mientras que
AutoBiTCN \textbf{empata} con ETS/Theta en FAD ($0.114$ frente a $0.117$). Una validación
con ocho semillas precisa esta lectura: en DFF la ventaja es \textbf{holgada y estable}
(media $0.090\pm0.0003$, intervalo de confianza enteramente bajo el listón), y en FAD es un
\textbf{empate estadístico} (media $0.114\pm0.008$, intervalo $[0.108,\,0.121]$ que contiene
el listón $0.117$). La conclusión, por tanto, depende del régimen: \textbf{el aprendizaje
