...
Estadísticos \cita{2} & ARIMA, SARIMA & Tendencia/estacionalidad lineal \\
Suavizamiento & ETS amortiguado, Theta, Kalman & Tendencia parsimoniosa \\
Aditivo \cita{3} & Prophet & Tendencia con cambios de régimen \\
Árboles sobre deltas \cita{6} & XGBoost, LightGBM, CatBoost & Rezagos + regresores, extrapolación \\
Lineales/profundos \cita{4}\cita{5}\cita{9} & DLinear, NLinear, RLinear, TiDE, & No linealidad y capacidad alta \\
...
Los árboles de potenciación de gradiente se optimizan con \textit{Optuna} \cita{19}
...
Diebold-Mariano \cita{22} (corrección de Holm) y, dado el tamaño del pool, con el conjunto de
confianza de modelos (Model Confidence Set) \cita{23} y el ranking de Friedman-Nemenyi
\cita{24} sobre las 25 series, fijados de antemano.
...
potenciación de gradiente se optimizaron con \textit{Optuna} \cita{19} bajo el protocolo
...
fuga, estrategias de conjunto sobre los pronósticos del hold-out \cita{20}. La
...
\textit{distribución predictiva completa}, medida con el CRPS (\textit{Continuous Ranked Probability Score}) \cita{21} sobre los
...
prestada del resto \cita{20}. Como el modelo global exige series continuas, los meses en
...
\item\label{bib:19} T. Akiba, S. Sano, T. Yanase, T. Ohta, y M. Koyama, ``Optuna: A
next-generation hyperparameter optimization framework,'' en \textit{Proc. 25th ACM
SIGKDD}, 2019, pp. 2623--2631.
\item\label{bib:20} S. Makridakis, E. Spiliotis, y V. Assimakopoulos, ``The M4
...
\item\label{bib:21} T. Gneiting y A. E. Raftery, ``Strictly proper scoring rules,
...
\item\label{bib:22} F. X. Diebold y R. S. Mariano, ``Comparing predictive
accuracy,'' \textit{Journal of Business \& Economic Statistics}, vol. 13,
n.\textsuperscript{o} 3, pp. 253--263, 1995.
\item\label{bib:23} P. R. Hansen, A. Lunde, y J. M. Nason, ``The model confidence
set,'' \textit{Econometrica}, vol. 79, n.\textsuperscript{o} 2, pp. 453--497, 2011.
\item\label{bib:24} J. Dem\v{s}ar, ``Statistical comparisons of classifiers over
