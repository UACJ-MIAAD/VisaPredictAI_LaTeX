...
conocido sino BiTCN. \textit{Cautela metodológica:} el resultado de AutoBiTCN ($0.108$)
corresponde a una sola corrida con semilla fija; aunque el margen sobre los parsimoniosos
($\sim$9\,\%) es consistente con su ventaja en DFF, su carácter \textbf{definitivo
requiere confirmación con múltiples semillas} (media e intervalo de confianza), tarea que
queda como validación inmediata antes de elevar esta conclusión a resultado central.
...
debajo de ETS/Theta $0.118$) y BiTCN $=0.088$ en DFF (frente a $0.100$ de SARIMA). La
